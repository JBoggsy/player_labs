"""Inspect stencil tunables and build validated Coworld upload arguments.

Examples:

  uv run python -m paintbot.stencil.tuning dump
...
def _parser() -> argparse.ArgumentParser:
    ...
    secret_env.add_argument(
        ...
        metavar="NAME=VALUE",
        nargs="+",
        help="config names or STENCIL_* environment names",
    )
    return parser
