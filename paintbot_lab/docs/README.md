...
| [`designs/strategy-idle-aim-intent-2026-08-29.md`](designs/strategy-idle-aim-intent-2026-08-29.md) | idle-aim center re-homed to the typed Intent (`idleAimCenterBrads`) — completes the sketch's threat-axis kill; the strategy rework's opening move | shipped as v69 (Codex-reviewed design, bit-identical transcription) |
...
| [`reports/paintbot-s2-league-state-2026-09-02.md`](reports/paintbot-s2-league-state-2026-09-02.md) | "Paintbot Season 2: the field, the policies, and where to start" — every S2 league policy (performance from a 615-episode results sweep, strategy from 55 replays' call/intent/lobby records, forum statements, lobby-chat behaviour), the three starters, and the starter-playbook recommendation — researched at coworld-ctf `4f25e7a7`; commentable HTML render alongside ([`.html`](reports/paintbot-s2-league-state-2026-09-02.html)) | the S2 policy-build pre-read; working data under `.reports-working/paintbot-s2-league-state-2026-09-02/` |
| [`reports/ctf-season-two-framework-2026-09-01.md`](reports/ctf-season-two-framework-2026-09-01.md) | "Season Two" research report: the play-calling shell (playbooks of WASM plays, ladder calls, the engine-hosted body), policy/game contracts, observations and actions, the seven reference plays and starter policies — researched at coworld-ctf `e9bc0bee`; commentable HTML render alongside ([`.html`](reports/ctf-season-two-framework-2026-09-01.html)) | the S2 epoch pre-read; the socket view is JSON again since #353 |
...
| [`recon/threat-axis-idle-aim-2026-08-29.md`](recon/threat-axis-idle-aim-2026-08-29.md) | pre-removal map of the v68 idle-aim mechanism: consumer census, tick ordering, parity traps (lazy oscillator, dead ticks) — the evidence base for the v69 design |
| [`reports/nav-init-profile-2026-08-03.md`](reports/nav-init-profile-2026-08-03.md) | navigation startup profile |
| [`reports/stencil-navigation-deep-dive-2026-08-08.md`](reports/stencil-navigation-deep-dive-2026-08-08.md) | full navigation recon for the simplification refactor: predicate hierarchy answer, the seven reason-string lists, severity-graded debt, engine ground truth — commentable HTML render alongside ([`.html`](reports/stencil-navigation-deep-dive-2026-08-08.html)) |
