...
ones that recur across sessions into durable practices here. Until that happens,
this file is intentionally near-empty — the live, evolving game knowledge lives in
[`WORKING_CONTEXT.md`](WORKING_CONTEXT.md), [`docs/`](docs/), and the buffer.

_(No promoted Vanilla WoW practices yet — the lab was just created.)_
