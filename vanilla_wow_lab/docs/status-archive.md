# Vanilla WoW working-context archive

Historical `## Status` sections rotated out of [`../WORKING_CONTEXT.md`](../WORKING_CONTEXT.md)
on 2026-08-04 to keep that file to its stated job: the one-screen "where are we and why."

Nothing here is current. These are point-in-time session records, newest first, covering
2026-07-13 through 2026-07-27 — the lab's creation, the v1-v45 waypoint/nav ladder, the
0.1.31 contract migration, and the 2026-07-27 upstream contract rewrite. Later status
(0.1.124 onward) still lives in `WORKING_CONTEXT.md`.

Treat every claim as stale unless re-verified against the code.
...
[`docs/recon/player-contract-0131-2026-07-21.md`](recon/player-contract-0131-2026-07-21.md),
...
- **Five docs**, from a deep read of the game repo + web research (with citations):
  [`docs/vanilla-wow-gameplay.md`](vanilla-wow-gameplay.md) (the game, accessibly),
  [`docs/vanilla-wow-player-contract.md`](vanilla-wow-player-contract.md) (the Nim wire
  contract, narrative), [`docs/vanilla-wow-protocol.md`](vanilla-wow-protocol.md) (the
  **exhaustive** interface-protocol reference — every message/schema/binary format, field-level),
  [`docs/vanilla-wow-rfc-roles.md`](vanilla-wow-rfc-roles.md) (the 5 RFC roles + round
  scoring), and [`docs/vanilla-wow-strategy-guide.md`](vanilla-wow-strategy-guide.md)
