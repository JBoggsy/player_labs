...
TOWER_HP = [950, 1300, 1950]        # outer, inner, gate (sim.nim TowerHitPoints)
TOWER_DMG = [18, 24, 30]            # once per second (sim.nim TowerDamages)
TOWER_RANGE = [5.0, 5.5, 6.0]
BARRACKS_HP = TOWER_HP[0]           # sim.nim: barracks use TowerHitPoints[OuterTower]
FORT_HP = 400
REWARDS = {'footman': (25, 15), 'hero': (150, 100), 'tower': (100, 75)}  # a barracks pays the tower reward
START_GOLD = 150
RESPAWN_TICKS = 24 + 192
SPAWN_INTERVAL_TICKS = 480          # configs.nim DefaultSpawnIntervalTicks
CREEPS_PER_BARRACKS, BARRACKS_PER_LANE, LANES = 3, 2, 3
CREEPS_PER_WAVE_PER_TEAM = CREEPS_PER_BARRACKS * BARRACKS_PER_LANE * LANES  # 18
CREEP_XP_PER_S_PER_TEAM = CREEPS_PER_WAVE_PER_TEAM * REWARDS['footman'][0] / (SPAWN_INTERVAL_TICKS / TICK)  # enemy creep XP on offer, all lanes
CREEP_XP_PER_S_PER_LANE = CREEP_XP_PER_S_PER_TEAM / LANES
