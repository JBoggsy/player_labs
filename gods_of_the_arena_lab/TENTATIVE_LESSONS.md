...
- **Target last hits explicitly.** Mechanics: all income is the killing hit; `objectHp` is
  visible; poison (35) always kills a footman below 35. Evidence needed: XP and gold curves
  versus the starter over matched episodes.
- **Spend gold immediately, damage first.** Mechanics: item value is set at purchase and
  eroded by every level; +14 damage is 33–64% of L1 damage. Evidence needed: level-10
