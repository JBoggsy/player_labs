...
Semantic review focused on the root workflow/preferences/onboarding, shared skills and executable contracts, game entry points, working contexts, Paintbot result/seating assumptions and learning lifecycle. Historical reports/design discussions remain dated evidence, not automatically current instructions. The stored [document inventory](learning-evidence-2026-09-14/document-inventory.json) records **169 unresolved historical targets**, chiefly archived-buffer links relative to their old location and source paths from older navigation reports. Originals were preserved rather than rewriting historical evidence to point at unrelated present-day code. This is not a claim that every historical command/link remains executable.
...
5. **Live contracts and historical links:** re-resolve live state at use; archived source/temporary artifacts may no longer exist. The [TODO](../../TODO.md) carries concrete provenance and authenticated-readback follow-ups.
