...
- **crewborg** — per-tick **JSON-lines** trace (perception, suspicion beliefs, mode
  ...
  [`../crewrift/crewborg/docs/trace-logs.md`](../crewrift/crewborg/docs/trace-logs.md). crewborg
...
- **Align by tick.** Find the event (timeline or log lifecycle), then read the
  ...
  `suspicion_snapshot` — see [`../crewrift/crewborg/docs/trace-logs.md`](../crewrift/crewborg/docs/trace-logs.md)).
