...
The vendored warehouse lives at ``crewrift_lab/tools/event-warehouse/`` and is run via uv, so
...
REPO = HERE.parents[5]  # crewrift_lab/.claude/skills/crewrift-event-warehouse/scripts -> repo root
WH_DIR = REPO / "crewrift_lab/tools/event-warehouse/crewrift-event-warehouse"
FETCH = REPO / ".claude/skills/coworld-episode-artifacts/scripts/fetch_artifacts.py"
