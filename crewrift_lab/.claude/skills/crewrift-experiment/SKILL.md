...
3. **Instrumentation or a code change** *(last — when the signal isn't observable yet)*. Add tracing
   (`CREWBORG_TRACE_*`, see [`trace-logs.md`](../../../crewrift/crewborg/docs/trace-logs.md)) or a probe behaviour,
...
follow [`report-style.md`](../../../docs/report-style.md) and **look at the rendered page**
before showing it.
