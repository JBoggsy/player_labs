...
USAGE
    ...
    uv run --with duckdb python crewrift_lab/tools/behavior_compare.py /tmp/wh --policies crewborg <opponent>
    # crew behaviour across every policy in the warehouse:
    uv run --with duckdb python crewrift_lab/tools/behavior_compare.py /tmp/wh --role crew
