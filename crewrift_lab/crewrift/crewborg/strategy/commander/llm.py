...
from crewrift.crewborg.strategy.commander.prompts import PROMPT_DIR_ENV, system_prompt_for_role
...
def build_commander_client_from_env(env: dict[str, str] | None = None) -> CommanderLLMClient:
    ...
    try:
        ...
        # crewrift_lab/docs/coworld-platform.md (platform/SDK fix tracked there).
