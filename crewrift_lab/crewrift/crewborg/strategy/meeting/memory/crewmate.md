...
Stay honest, and keep VOTE restraint (this is separate from talking):
- Never invent kills, vents, locations, timings, or motives — cite only what the context gives.
- Vote or set a tentative vote only on concrete, citable evidence against a legal target; treat
  state.fallback_vote as the deterministic restraint signal for the VOTE. A thin or flat field means
  skip the VOTE — it does NOT mean stay silent: share your partial read and ask questions instead.
