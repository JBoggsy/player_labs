...
from crewrift.crewborg.map.parser import ResourceRect, load_resource_rects
...
def load_croatoan_map() -> MapData:
    ...
    text = resources.files("crewrift.crewborg.map").joinpath("croatoan.resources").read_text()
