...
Run:
    uv run python crewrift_lab/crewrift/crewborg/tools/path_prediction_ui.py \\
...
from crewrift.crewborg import navbake  # noqa: E402
from crewrift.crewborg.map.types import MapData, MapPoint, MapRect, Room, TaskStation, Vent  # noqa: E402
from crewrift.crewborg.nav import build_nav_graph  # noqa: E402
from crewrift.crewborg.strategy.path_prediction import PathPredictor  # noqa: E402
