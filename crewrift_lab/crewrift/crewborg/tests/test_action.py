...
from crewrift.crewborg.action import (
    BTN_A,
    BTN_B,
    BTN_DOWN,
    BTN_LEFT,
...
from crewrift.crewborg.types import ActionState, Belief, BodyEntry, Intent, PlayerRecord
...
def test_periodic_replan_reroots_the_route_on_interval() -> None:
    from crewrift.crewborg.action import REPLAN_INTERVAL
