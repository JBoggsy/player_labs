...
from crewrift.crewborg.navbake import NAVBAKE_FORMAT, load_navbake, serialize_navbake
...
def test_load_navbake_accepts_exact_mask_and_rejects_changes() -> None:
    ...
    from crewrift.crewborg.navbake import NAVBAKE_PACKAGE, NAVBAKE_RESOURCE
