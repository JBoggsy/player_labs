...
from crewrift.crewborg.types import Belief, Percept, update_belief
...
def test_roster_history_is_bounded() -> None:
    from crewrift.crewborg.types import ROSTER_HISTORY_MAX, PlayerRecord
...
def test_tape_records_camera_ready_frames_with_viewport_and_entities() -> None:
    from crewrift.crewborg.perception.entities import VisibleBody, VisiblePlayer
...
def test_tape_is_bounded() -> None:
    from crewrift.crewborg.types import RECENT_FRAMES_MAX
...
def test_meeting_clears_in_world_bodies_but_keeps_the_death() -> None:
    from crewrift.crewborg.perception.entities import VisibleBody, VotingState
...
def test_census_records_alive_and_dead_players_by_color() -> None:
    from crewrift.crewborg.perception.entities import CensusEntry
...
def test_chat_log_accumulates_dedups_and_resets_each_meeting() -> None:
    from crewrift.crewborg.perception.entities import ChatLine, VotingState
