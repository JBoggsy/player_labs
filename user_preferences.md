...
- **Preserve evidence when consolidating learning** (James, 2026-09-14). Promote
  recurring findings supported by independent evidence. Keep one-off and game-version-
  dependent findings tentative or scoped; preserve the source records and explain
  promotions. Modernize supported tool integrations without changing player behavior
  or live leagues.
